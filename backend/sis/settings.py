"""
Django settings for Smart Irrigation System project.
"""
...
# Use irrigation_system as the database name
MONGODB_URI = os.environ.get('MONGODB_URI', 'mongodb://localhost:27017/irrigation_system')
